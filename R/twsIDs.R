...
`.twsOutgoingMSG` <-
  structure(list(
    REQ_MKT_DATA = "1", CANCEL_MKT_DATA = "2", PLACE_ORDER = "3",
    ...
    "REQ_REAL_TIME_BARS", "CANCEL_REAL_TIME_BARS", "REQ_FUNDAMENTAL_DATA", "CANCEL_FUNDAMENTAL_DATA",
    "REQ_CALC_IMPLIED_VOLAT", "REQ_CALC_OPTION_PRICE", "CANCEL_CALC_IMPLIED_VOLAT",
    "CANCEL_CALC_OPTION_PRICE"
  ))

`.twsIncomingMSG` <-
  structure(list(
    TICK_PRICE = "1", TICK_SIZE = "2",
